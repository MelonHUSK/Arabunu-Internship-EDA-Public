...
df["DiabetesPedigreeFunction_cat"] = pd.cut(df['DiabetesPedigreeFunction'],
                                            bins=[0, 0.50, 1, 1.50, 2.50],
                                            labels=["DiabetesPedigreeFunction_0_0.50", "DiabetesPedigreeFunction_0.51_1", "DiabetesPedigreeFunction_1.01_1.50", "DiabetesPedigreeFunction1.51_2.50"])
