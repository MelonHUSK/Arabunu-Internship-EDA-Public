...
df_ = pd.read_excel("/Users/dorukakalin/Desktop/Python Internship/Cohort Analysis/online_retail.xlsx")
df = df_.copy()
df.head()
...
new_df.to_csv("/Users/dorukakalin/Desktop/Python Internship/Zorunlu Ödev/Loyal_customer.csv")
